...
class Movie(models.Model) :
    ...
    popularity = models.IntegerField(),         # 유명도
    ...
    budget = models.IntegerField(),             # 예산
    veteAver = models.IntegerField(),           # 투표 평균
    voteCount = models.IntegerField(),          # 투표 개수
...
class Opinion(models.Model) :
    ...
    name = models.CharField(max_length=50),   # 유저 네임
    content = models.TextField(),    # 댓글 내용
    push = models.IntegerField(),    # 추천수
